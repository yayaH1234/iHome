...
public class ModiffMaisActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                postMaison(bitmap,mais_name,email);
            }
        });
...
*/
    ...
    private void postMaison(final Bitmap imageBitmap,final String mais_name, final String email ) {
        ...
        Toast.makeText ( ModiffMaisActivity3.this,"successufl",Toast.LENGTH_SHORT ).show ();
        Intent intent=new Intent(ModiffMaisActivity3.this,MainActivity.class);
